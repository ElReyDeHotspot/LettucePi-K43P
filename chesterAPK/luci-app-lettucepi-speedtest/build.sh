...
chmod 0755 "$STAGE/files/usr/libexec/lettucepi-speedtest" "$STAGE/scripts/"*

"$APK" mkpkg \
  --info "name:luci-app-lettucepi-speedtest" \
  --info "version:$VERSION" \
  --info "description:LuCI interface for the official Ookla Speedtest CLI" \
