...
apn:value("fast.t-mobile.com", "T-MOBILE")
apn:value("fbb.home", "T-MOBILE HOME")
apn:value("nrbroadband", "AT&T 5G TAB")
apn:value("vzwinternet", "VERIZON")
apn:value("enhancedphone", "AT&T 5G PHONE")
apn:value("broadband", "AT&T")
